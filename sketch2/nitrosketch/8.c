...
Nitrosketch ns1 = Nitrosketch(327680, 0.5);
Nitrosketch ns2 = Nitrosketch(327680, 0.5);
Nitrosketch ns3 = Nitrosketch(327680, 0.5);
Nitrosketch ns4 = Nitrosketch(327680, 0.5);
Nitrosketch ns5 = Nitrosketch(327680, 0.5);
Nitrosketch ns6 = Nitrosketch(327680, 0.5);
Nitrosketch ns7 = Nitrosketch(327680, 0.5);
Nitrosketch ns8 = Nitrosketch(327680, 0.5);
...
void got_packet(u_char *argv, const struct pcap_pkthdr *header, const u_char *packet)
{
    ...
    ns1.insert(ft, sizeof(fivetuple));
    ns2.insert(ft, sizeof(fivetuple));
    ns3.insert(ft, sizeof(fivetuple));
    ns4.insert(ft, sizeof(fivetuple));
    ns5.insert(ft, sizeof(fivetuple));
    ns6.insert(ft, sizeof(fivetuple));
    ns7.insert(ft, sizeof(fivetuple));
    ns8.insert(ft, sizeof(fivetuple));
