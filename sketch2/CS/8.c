...
CountSketch<4, 8> cs1 = CountSketch<4, 8>(10485760);
CountSketch<4, 8> cs2 = CountSketch<4, 8>(10485760);
CountSketch<4, 8> cs3 = CountSketch<4, 8>(10485760);
CountSketch<4, 8> cs4 = CountSketch<4, 8>(10485760);
CountSketch<4, 8> cs5 = CountSketch<4, 8>(10485760);
CountSketch<4, 8> cs6 = CountSketch<4, 8>(10485760);
CountSketch<4, 8> cs7 = CountSketch<4, 8>(10485760);
CountSketch<4, 8> cs8 = CountSketch<4, 8>(10485760);
