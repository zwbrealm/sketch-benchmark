...
UnivMon um1 = UnivMon(10000000);
UnivMon um2 = UnivMon(10000000);
UnivMon um3 = UnivMon(10000000);
UnivMon um4 = UnivMon(10000000);
UnivMon um5 = UnivMon(10000000);
UnivMon um6 = UnivMon(10000000);
UnivMon um7 = UnivMon(10000000);
UnivMon um8 = UnivMon(10000000);
