...
FlowRadar fr1 = FlowRadar(10485760, 3, 3, 0.1);
FlowRadar fr2 = FlowRadar(10485760, 3, 3, 0.1);
FlowRadar fr3 = FlowRadar(10485760, 3, 3, 0.1);
FlowRadar fr4 = FlowRadar(10485760, 3, 3, 0.1);
FlowRadar fr5 = FlowRadar(10485760, 3, 3, 0.1);
FlowRadar fr6 = FlowRadar(10485760, 3, 3, 0.1);
FlowRadar fr7 = FlowRadar(10485760, 3, 3, 0.1);
FlowRadar fr8 = FlowRadar(10485760, 3, 3, 0.1);
