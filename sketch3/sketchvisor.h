...
struct fivetuple2
{
    ...
    bool operator <(const fivetuple2& other) const
    {
...
class SketchVisor {
public:
    map<struct fivetuple2, u_int32_t> fastpath_htbl;
...
//        cout << "m=" << this->m << " n=" << this->n << endl;
    ...
    void update(struct fivetuple2 *key){
        ...
        if (update_cm) {
            ...
            std::map<struct fivetuple2, u_int32_t>::iterator it = fastpath_htbl.find(*key);
