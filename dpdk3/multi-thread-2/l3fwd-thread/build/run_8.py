...
cmd = []
for i in app_list:
    tmp_cmd = 'timeout -s SIGKILL 60s ./'+i+' '+run_cmd
    cmd.append(tmp_cmd)
...
for cmd_tmp in cmd: 
    ...
    print(str(name)+' cores:'+str(num_cores_2)+':' + '  cycle: '+str(avg_cpu_cycle)+'  throughoutput  '+str(overall_throughoutput))
    with open('res.txt','a') as f:
        f.write(str(name)+' cores:'+str(num_cores_2)+':' + '  cycle:'+str(avg_cpu_cycle)+'  throughput '+str(overall_throughoutput)+'\n')
...
print((2642+2664+2687+2691+2742+2780+2824+2643)/8)
print(681420+676019+670301+669266+656660+647976+637579+630154)
